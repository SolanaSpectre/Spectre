...
const CONFIG_GETTER_ALLOWLIST = [
  ...
  'launchIntelSource',
  'launchIntelEnabled',
  'launchIntelFlushIntervalMs',
  'launchIntelIndexFlushIntervalMs',
  'launchIntelRuntimeFlushEnabled',
  'launchIntelMaxTrackedTokens',
  'launchIntelMaxEarlyBuys',
  'launchIntelSniperWindowMs',
  'launchIntelBundlerWindowMs',
  'launchIntelBundlerMinWallets',
  'heliusPumpfunShadowEnabled',
  'heliusPumpfunRuntimeEnabled',
  'heliusPumpfunShadowCommitment',
  'heliusPumpfunShadowPingIntervalMs',
  'heliusPumpfunShadowPongTimeoutMs',
  'heliusPumpfunShadowSubscriptionAckTimeoutMs',
  'heliusPumpfunShadowReconnectDelayMs',
  'heliusPumpfunShadowMaxReconnectDelayMs',
  'heliusPumpfunShadowEventQueueMaxSize',
  'heliusPumpfunShadowEventQueueBatchSize',
  'heliusPumpfunRuntimeQueueMaxSize',
  'heliusPumpfunDecisionShadowEnabled',
  'providerCurveVerificationEnabled',
  'solanaRpcPrimaryDowngradeMs',
  'solanaRpcPrimaryFailureThreshold',
  'solanaRpcFallbackFailureThreshold',
  'solanaRpcSameVendorFallbackEnabled',
  'solanaRpcMaxConcurrentRequests',
  'solanaRpcMinRequestIntervalMs',
  'solanaRpcCallTimeoutMs',
  'solanaRpcHttpAgentMode',
  'solanaRpcHttpAgentKeepAliveMsecs',
  'solanaRpcHttpAgentMaxSockets',
  'solanaRpcHttpAgentMaxFreeSockets',
  'solanaRpcHttpAgentTimeoutMs',
  'solanaRpcHttpAgentScheduling',
  'solanaRpcAccountReadTransport',
  'solanaRpcFallbackDowngradeMs',
  'solanaRpcAccountInfoCacheTtlMs',
  'paperRunnerModeEnabled',
  'paperRunnerRequirePumpMigration',
  'paperRunnerMinMigratedLiquidityUsd',
  'pumpDevFeedMode',
