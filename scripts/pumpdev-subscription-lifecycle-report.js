...
function buildReport(filePath) {
  ...
  return {
    ...
    summary: {
      ...
      tradeSubscriptionMode: stats.tradeSubscriptionMode || replayConfig?.pumpDevTradeSubscriptionMode || null,
      targetedSubscriptionRequests: number(stats.targetedSubscriptionRequests),
      targetedSubscriptionRefreshes: number(stats.targetedSubscriptionRefreshes),
      targetedSubscriptionEvictions: number(stats.targetedSubscriptionEvictions),
