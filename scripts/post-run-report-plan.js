const ALL_POST_RUN_REPORTS = [
  ...
  { title: 'Pre-Migration Curve60 Supply Decomposition', script: 'pre-migration-curve60-supply-decomposition-report.js' },
  { title: 'Pre-Migration Watch-vs-Crosser Supply', script: 'pre-migration-watch-vs-crosser-supply-report.js' },
  { title: 'Pre-Migration Runner No-Entry Autopsy', script: 'pre-migration-runner-no-entry-autopsy-report.js' },
  { title: 'Pre-Migration Runner Watch Funnel', script: 'pre-migration-runner-watch-funnel-report.js' },
  { title: 'Pre-Migration Advancing High-Curve Lane Gap', script: 'pre-migration-advancing-high-curve-lane-gap-report.js', timeoutMs: 300000 },
  { title: 'Pre-Migration Pre60 Snapshot Coverage', script: 'pre-migration-pre60-snapshot-coverage-report.js', timeoutMs: 300000 },
  ...
  { title: 'Pre-Migration Early-Signal First-Hit Replay', script: 'pre-migration-early-signal-first-hit-replay-report.js', timeoutMs: 300000 },
  { title: 'Pre-Migration Early-Signal Entry-Timing Replay', script: 'pre-migration-early-signal-entry-timing-replay-report.js', timeoutMs: 300000 },
